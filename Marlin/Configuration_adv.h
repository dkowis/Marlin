...
//TODO: 0,0,0 for sensorless homing
...
#define LIN_ADVANCE
  ...
  // Default disable linear advance for right now
 ...
 */
// Enabling this, and I can turn it on in octoprint
// Except this is incompatible with Linear advance.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH        2.5  // (mm) Length to extrude after loading.
  ...
  //#define ADVANCED_PAUSE_FANS_PAUSE             // Turn off print-cooling fans while the machine is paused.
                                                  ...
                                                  // So this helps empty the nozzle completely. It's actually useful.
...
// Extruder microsteps is going back to 16, because shit's gettin weird.
  #if AXIS_IS_TMC(E0)
    //20 Dec 2020
    // Extruder current only needs to be 500, because geared extruder
